...
private:
	...
	/** Item rarity - determines the stars in the Pickup Widget */
	...
	/** Item State - determines the state of the item */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Item Properties", meta = (AllowPrivateAccess = "true"))
	...
	/** Damage modifier for weapon per rarity */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = Rarity, meta = (AllowPrivateAccess = "true"))
	float DamageModifier;
...
public:
	...
	FORCEINLINE float GetDamageModifier() const { return DamageModifier; }
};
